...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 10, 2018 at 06:43 PM
...
CREATE TABLE IF NOT EXISTS `tbl_activitys` (
...
CREATE TABLE IF NOT EXISTS `tbl_billinginvoice` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
(1, 1, 1, 1000, '2018-06-19', '1', '1.35', '1.50', '10', '1000.00', 'B123', 1, '2018-06-11 07:35:06');
...
(1, 1, '#12345', 1000, 0, 1, '2018-06-11 07:35:06');
...
(1, 'DEC1080', 'DEPTHNG 10MG', 'HSV6276', NULL, NULL, 0, 0, '5.00', '5.00', '10', 1, '2018-06-11 07:12:02');
...
(1, 'Davey', 'Davey', 'ajith@gmail.com', 8124661819, 'fgjgjj', 'cgchhh', 'TamilNadu', '600017', '12345678', 1, '2018-06-08 15:37:57');
...
CREATE TABLE IF NOT EXISTS `txt_billingproduct` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `txt_billingNo` int(11) NOT NULL,
  `txt_productName` varchar(100) NOT NULL,
